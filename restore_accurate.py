...
broken_updateStatus = "function updateStatus(id, status) {();\n  guardarDatos();\n}"
fixed_updateStatus = """function updateStatus(id, status) {
...
broken_saveShipment = "function saveShipment() {(newShipment.id);\n  guardarDatos();\n}"
fixed_saveShipment = """function saveShipment() {
...
broken_updateStatusFromDetail = "function updateStatusFromDetail() {();\n  guardarDatos();\n}"
fixed_updateStatusFromDetail = """function updateStatusFromDetail() {
...
broken_savePartner = "function savePartner() {();\n  guardarDatos();\n}"
fixed_savePartner = """function savePartner() {
...
broken_selectStatus = "function selectStatus(shipId, status, e) {();\n  guardarDatos();\n}"
fixed_selectStatus = """function selectStatus(shipId, status, e) {
  e.stopPropagation();
...
broken_savePallet = "function savePallet() {();\n  guardarDatos();\n}"
fixed_savePallet = """function savePallet() {
...
print("Direct String replacements complete")
